        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isSelected ? const Color(0xFF3A4756).withValues(alpha: 0.08) : Colors.transparent,
              borderRadius: BorderRadius.circular(10),
            ),
            child: Row(
              children: [
                Radio(
                  ...
                  activeColor: const Color(0xFF3A4756),
                ...
                Expanded(
                  child: Text(
                    title!,
                    style: isSelected
                        ? rubikMedium.copyWith(color: const Color(0xFF3A4756))
                        : rubikRegular,
                  ),
                ),
              ],
